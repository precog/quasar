...
trait SliceTransforms[M[+ _]]
                ...
                new Slice {
                  ...
                  val columns: Map[ColumnRef, Column] = {
                    if (sl.columns.isEmpty || sr.columns.isEmpty) {
                      ...
                      val (emptyBits, nonemptyBits) = buildInnerBits(leftEmptyBits,
                                                                     rightEmptyBits,
                                                                     leftObjectBits,
                                                                     rightObjectBits)
  ...
  object SliceTransform1 {
    ...
    private[table] val Identity: SliceTransform1S[Unit] = SliceTransform1S[Unit]((), {
      (u, s) =>
        (u, s)
    })
    ...
    private def chainS[A, B](sta: SliceTransform1S[A],
    ...
    private def chain[A, B](st0: SliceTransform1[A],
    ...
    private[table] case class SliceTransform1SMS[A, B, C](before: SliceTransform1S[A],
  ...
  object SliceTransform2 {
    ...
    private def chainS[A, B](sta: SliceTransform2S[A],
    ...
    private def chain[A, B](st0: SliceTransform2[A],
