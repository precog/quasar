...
object N1QL extends N1QLInstances {
  ...
  object IfMissing {
    def apply[A](a1: A, a2: A, a3: A*): IfMissing[A] =
      IfMissing(oneAnd(a1, nels(a2, a3: _*)))
  }
  object IfMissingOrNull {
    def apply[A](a1: A, a2: A, a3: A*): IfMissingOrNull[A] =
      IfMissingOrNull(oneAnd(a1, nels(a2, a3: _*)))
  }
  object Least {
  ...
  object Select {
    ...
    final case class LookupJoin[A](id: Id[A],
                                   alias: Option[Id[A]],
                                   pred: A,
