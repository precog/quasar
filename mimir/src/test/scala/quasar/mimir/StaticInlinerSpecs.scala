...
trait StaticInlinerSpecs[M[+ _]] extends EvaluatorSpecification[M] {
  ...
  "static inlining of Root computation" should {
    "detect and resolve addition" in {
      ...
      val input =
        Join(Add, Cross(None), Const(CLong(42))(line), Const(CNum(3.14))(line))(line)
    ...
    "produce CUndefined in cases where the operation is undefined" in {
      ...
      val input =
        Join(Div, Cross(None), Const(CLong(42))(line), Const(CLong(0))(line))(line)
    ...
    "detect and resolve object" >> {
      ...
      "deref" >> {
        ...
        inlineStatics(input, defaultEvaluationContext) mustEqual Const(CBoolean(false))(
          line)
      }
