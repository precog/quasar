...
trait JoinOptimizerSpecs[M[+ _]]
  ...
  "join optimization" should {
    ...
    "eliminate naive cartesian products in trivial object join cases" in {
      ...
      val heightWeight =
        dag.AbsoluteLoad(Const(CString("/hom/heightWeight"))(line), JUniverseT)(line)
          ...
          Join(
            ...
            Join(
              ...
              Join(
                ...
                price)(line))(line),
            Join(WrapObject, Cross(Some(CrossRight)), value, conversionsData)(line)
          )(line),
          "key",
          "value",
          0
    ...
    "eliminate naive cartesian products in trivial array join cases" in {
      ...
      val input =
        Filter(
          ...
          Join(
            JoinArray,
            Cross(None),
            Operate(WrapArray, Join(DerefObject, Cross(None), heightWeight, height)(line))(
              line),
            Operate(WrapArray, Join(DerefObject, Cross(None), users, name)(line))(line)
          )(line),
          Join(
            Eq,
            Cross(None),
      ...
      val expectedOpt =
        Join(
          JoinArray,
          ValueSort(0),
          Operate(WrapArray, Join(DerefObject, Cross(None), liftedLHS, height)(line))(line),
          Operate(WrapArray, Join(DerefObject, Cross(None), liftedRHS, name)(line))(line)
        )(line)
      ...
      def makeAddSortKey(key: DepGraph, value: DepGraph) =
        AddSortKey(
          Join(
            JoinObject,
            IdentitySort,
            Join(WrapObject, Cross(Some(CrossRight)), Const(CString("key"))(line), key)(line),
            Join(WrapObject, Cross(Some(CrossRight)), Const(CString("value"))(line), value)(
              line)
          )(line),
          "key",
          "value",
    ...
    "eliminate cartesian with a new inside an array join" in {
      ...
      val input = Filter(
        ...
        Join(
          ...
          Join(
            JoinArray,
            Cross(None),
            Operate(WrapArray, Join(DerefObject, Cross(None), newMedals, name)(line))(line),
            Operate(WrapArray, Join(DerefObject, Cross(None), medals, name)(line))(line)
          )(line),
          Const(CLong(1))(line)
        )(line),
        Join(
      ...
      val expectedOpt = Join(
        ...
        Join(
          ...
          ValueSort(0),
          Operate(WrapArray, Join(DerefObject, Cross(None), liftedRHS, name)(line))(line),
          Operate(WrapArray, Join(DerefObject, Cross(None), liftedLHS, name)(line))(line)
        )(line),
        Const(CLong(1))(line)
      )(line)
    ...
    "eliminate cartesian with a new and a filter inside an array join" in {
      ...
      val expectedOpt =
        Join(
          JoinArray,
          ValueSort(0),
          Operate(WrapArray, Join(DerefObject, Cross(None), liftedLHS, country)(line))(line),
          Operate(WrapArray, Join(DerefObject, Cross(None), liftedRHS, country)(line))(line)
        )(line)
    ...
    "eliminate cartesian in medal winners query" in {
      ...
      def wrapName(graph: DepGraph) =
        Join(
          ...
          Operate(
            BuiltInFunction1Op(toLowerCase),
            Join(DerefObject, Cross(None), graph, Const(CString("name"))(line))(line))(line)
        )(line)

      val medalsPrime = Join(JoinObject, IdentitySort, medals, wrapName(medals))(line)

      val athletesPrime = Join(JoinObject, IdentitySort, athletes, wrapName(athletes))(line)
      ...
      val input = Filter(
        ...
        Join(
          ...
          Join(
            ...
            Join(DerefObject, Cross(None), medalsPrime, Const(CString("Medal winner"))(line))(
              line)
          )(line),
          Join(
            WrapObject,
            ...
            Join(DerefObject, Cross(None), athletesPrime, Const(CString("Countryname"))(line))(
              line)
          )(line)
        )(line),
        Join(
          Eq,
          Cross(None),
          Join(DerefObject, Cross(None), medalsPrime, Const(CString("name"))(line))(line),
          Join(DerefObject, Cross(None), athletesPrime, Const(CString("name"))(line))(line)
        )(line)
      )(line)
        ...
        AddSortKey(
          Join(
            ...
            Join(
              ...
              Cross(Some(CrossRight)),
              Const(CString("key"))(line),
              Join(DerefObject, Cross(None), athletesPrime, Const(CString("name"))(line))(
                line))(line),
            Join(
              WrapObject,
              Cross(Some(CrossRight)),
      ...
      val expected =
        Join(
          ...
          Join(
            ...
            Cross(Some(CrossRight)),
            Const(CString("winner"))(line),
            Join(DerefObject, Cross(None), liftedLHS, Const(CString("Medal winner"))(line))(
              line))(line),
          Join(
            WrapObject,
            Cross(Some(CrossRight)),
            Const(CString("country"))(line),
            Join(DerefObject, Cross(None), liftedRHS, Const(CString("Countryname"))(line))(
              line))(line)
        )(line)
      ...
      lazy val input =
        Filter(
          ...
          Join(
            ...
            Join(WrapObject, Cross(None), Const(CString("b"))(line), clicksP)(line)
          )(line),
          Join(
            Eq,
            Cross(None),
            Join(DerefObject, Cross(None), clicks, Const(CString("pageId"))(line))(line),
            Join(DerefObject, Cross(None), clicksP, Const(CString("pageId"))(line))(line)
          )(line)
        )(line)
