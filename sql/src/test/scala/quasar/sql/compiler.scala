...
class CompilerSpec extends quasar.Qspec with CompilerHelpers {
  ...
  "compiler" should {
    "compile simple constant example 1" in {
      testLogicalPlanCompile(sqlE"select 1", lpf.constant(Data.Int(1)))
    }

    "compile simple constant example 1 with field name" in {
      testLogicalPlanCompile(sqlE"select 1 as one",
                             makeObj("one" -> lpf.constant(Data.Int(1))))
    }

    "compile simple boolean literal (true)" in {
      testLogicalPlanCompile(sqlE"select true", lpf.constant(Data.Bool(true)))
    }

    "compile simple boolean literal (false)" in {
      testLogicalPlanCompile(sqlE"select false", lpf.constant(Data.Bool(false)))
    }

    "compile simple constant with multiple named projections" in {
      testLogicalPlanCompile(sqlE"""select 1.0 as a, "abc" as b""",
                             makeObj("a" -> lpf.constant(Data.Dec(1.0)),
    ...
    "compile simple constant from collection" in {
      testTypedLogicalPlanCompile(sqlE"select 1 from zips", lpf.constant(Data.Int(1)))
    }
            ...
            lpf.join(
              ...
              JoinCondition(
                ...
                lpf.invoke2(
                  Eq,
                  lpf.invoke2(ObjectProject,
                              lpf.joinSideName('__leftJoin9),
                              lpf.constant(Data.Str("x"))),
                  lpf.invoke2(ObjectProject,
                              lpf.invoke2(ObjectProject,
                                          lpf.joinSideName('__rightJoin10),
                                          lpf.constant(Data.Str("foo"))),
        ...
        lpf.let(
          ...
          lpf.let(
            ...
            lpf.let('__tmp4,
                    ...
                    lpf.typecheck(lpf.free('__tmp4),
                                  Type.Obj(Map(), Some(Type.Top)),
                                  lpf.free('__tmp4),
                                  lpf.constant(Data.NA))),
            lpf.join(
              lpf.invoke2(
                Filter, // filter left side types
                lpf.free('__tmp1),
                lpf.invoke2(
                  And,
                  lpf.invoke2(
              ...
              lpf.invoke2(
                Filter, // filter right side types
                lpf.free('__tmp3),
                lpf.typecheck(
                  lpf.invoke2(ObjectProject,
                              lpf.free('__tmp3),
                  ...
                  lpf.typecheck(
                    ...
                    lpf.let(
                      ...
                      lpf.invoke2(ObjectProject,
                                  lpf.free('__tmp9),
                                  lpf.constant(Data.Str("author"))),
                      lpf.typecheck(lpf.free('__tmp10),
                                    Type.Obj(Map(), Some(Type.Top)),
                                    lpf.invoke2(ObjectProject,
                                                lpf.free('__tmp10),
                                                lpf.constant(Data.Str("login"))),
                ...
                lpf.invoke2(
                  ...
                  lpf.invoke2(
                    ...
                    lpf.invoke2(
                      ...
                      lpf.let(
                        ...
                        lpf.typecheck(lpf.free('__tmp12),
                                      Type.Obj(Map(), Some(Type.Top)),
                                      lpf.invoke2(ObjectProject,
                                                  lpf.free('__tmp12),
                                                  lpf.constant(Data.Str("sha"))),
                        ...
                        lpf.typecheck(
                          ...
                          lpf.let(
                            ...
                            lpf.invoke2(ObjectProject,
                                        lpf.free('__tmp13),
                                        lpf.constant(Data.Str("author"))),
                            lpf.typecheck(lpf.free('__tmp14),
                                          Type.Obj(Map(), Some(Type.Top)),
                                          lpf.invoke2(ObjectProject,
                                                      lpf.free('__tmp14),
                                                      lpf.constant(Data.Str("login"))),
                  ...
                  lpf.invoke2(
                    ...
                    lpf.let(
                      ...
                      lpf.typecheck(lpf.free('__tmp15),
                                    Type.Obj(Map(), Some(Type.Top)),
                                    lpf.invoke2(ObjectProject,
                                                lpf.free('__tmp15),
                                                lpf.constant(Data.Str("sha"))),
                    ...
                    lpf.typecheck(
                      ...
                      lpf.let(
                        ...
                        lpf.invoke2(ObjectProject,
                                    lpf.free('__tmp16),
                                    lpf.constant(Data.Str("author"))),
                        lpf.typecheck(lpf.free('__tmp17),
                                      Type.Obj(Map(), Some(Type.Top)),
                                      lpf.invoke2(ObjectProject,
                                                  lpf.free('__tmp17),
                                                  lpf.constant(Data.Str("login"))),
    ...
    "compile qualified select *" in {
      testLogicalPlanCompile(sqlE"select foo.* from foo",
                             lpf.invoke1(Squash, read("foo")))
    }
        ...
        lpf.let(
          ...
          lpf.invoke1(
            ...
            makeObj(
              ...
              "place" -> lpf.invoke2(ObjectProject,
                                     lpf.free('__tmp0),
                                     lpf.constant(Data.Str("place")))
            )
          )
        )
      )
    ...
    "compile basic let" in {
      testLogicalPlanCompile(sqlE"foo := 5; foo", lpf.constant(Data.Int(5)))
    }

    "compile basic let, ignoring the form" in {
      testLogicalPlanCompile(sqlE"bar := 5; 7", lpf.constant(Data.Int(7)))
    }
    ...
    "compile simple 1-table projection when root identifier is also a table ref" in {
      ...
      testLogicalPlanCompile(sqlE"select foo.bar from foo",
                             lpf.invoke1(Squash,
                                         lpf.invoke2(ObjectProject,
                                                     read("foo"),
                                                     lpf.constant(Data.Str("bar")))))
    ...
    "compile conditional (match) without else" in {
      testLogicalPlanCompile(
        ...
        compileExp(
          sqlE"""select case when pop = 0 then "nobody" else null end from zips"""))
    }
    ...
    "compile conditional (switch) without else" in {
      testLogicalPlanCompile(
        ...
        compileExp(
          sqlE"""select case pop when 0 then "nobody" else null end from zips"""))
    }
    ...
    val setA =
      lpf.let(
        ...
        lpf.invoke1(
          Squash,
          makeObj(
            "loc" -> lpf.invoke2(ObjectProject,
                                 lpf.free('__tmp0),
                                 lpf.constant(Data.Str("loc"))),
            "pop" -> lpf.invoke2(ObjectProject,
                                 lpf.free('__tmp0),
                                 lpf.constant(Data.Str("pop")))
          )
        )
    ...
    "compile union" in {
      testLogicalPlanCompile(
        ...
        lpf.normalizeLets(
          lpf.normalizeLets(lpf.invoke1(Distinct, lpf.invoke2(Union, setA, setB)))))
    }

    "compile union all" in {
      testLogicalPlanCompile(
        sqlE"select loc, pop from zips union all select city from zips",
        lpf.normalizeLets(lpf.normalizeLets(lpf.invoke2(Union, setA, setB))))
    }
    ...
    "compile intersect" in {
      testLogicalPlanCompile(
        ...
        lpf.normalizeLets(
          lpf.normalizeLets(lpf.invoke1(Distinct, lpf.invoke2(Intersect, setA, setB))))
      )
    }
    ...
    "compile intersect all" in {
      testLogicalPlanCompile(
        ...
        lpf.normalizeLets(lpf.normalizeLets(lpf.invoke2(Intersect, setA, setB))))
    }

    "compile except" in {
      testLogicalPlanCompile(
        sqlE"select loc, pop from zips except select city from zips",
        lpf.normalizeLets(lpf.normalizeLets(lpf.invoke2(Except, setA, setB))))
    }

    "have {*} as alias for {:*}" in {
      testLogicalPlanCompile(sqlE"SELECT bar{*} FROM foo",
    ...
    "compile top-level map flatten" in {
      testLogicalPlanCompile(sqlE"select zips{:*} from zips",
    ...
    "have [_] as alias for [:_]" in {
      testLogicalPlanCompile(sqlE"select loc[_] / 10 from zips",
                             compileExp(sqlE"select loc[:_] / 10 from zips"))
    }

    "compile map shift / unshift" in {
      val inner = lpf.invoke1(ShiftMap,
                              lpf.invoke2(ObjectProject,
                                          lpf.invoke2(ObjectProject,
                                                      lpf.free('__tmp0),
                                                      lpf.constant(Data.Str("commit"))),
                                          lpf.constant(Data.Str("author"))))
    ...
    "compile map shift / unshift keys" in {
      val inner = lpf.invoke1(
        ShiftMapKeys,
        lpf.invoke2(
          ObjectProject,
          lpf.invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("commit"))),
          lpf.constant(Data.Str("author")))
      )
            ...
            lpf.invoke1(
              ...
              makeObj(
                "name" -> lpf.invoke2(ObjectProject,
                                      lpf.free('__tmp0),
                                      lpf.constant(Data.Str("name"))),
                "__sd__0" -> lpf.invoke2(ObjectProject,
                                         lpf.free('__tmp0),
    ...
    "compile simple order by with wildcard" in {
      testLogicalPlanCompile(
        ...
        lpf.let(
          '__tmp0,
          lpf.invoke1(Squash, read("person")),
          lpf.sort(lpf.free('__tmp0),
                   (lpf.invoke2(ObjectProject,
                                lpf.free('__tmp0),
                                lpf.constant(Data.Str("height"))),
                    SortDir.asc).wrapNel)
        ...
        lpf.let(
          ...
          lpf.invoke1(Squash,
                      makeObj(
                        "name" -> lpf.invoke2(ObjectProject,
                                              read("person"),
                                              lpf.constant(Data.Str("firstName"))))),
          lpf.sort(lpf.free('__tmp0),
                   (lpf.invoke2(ObjectProject,
                                lpf.free('__tmp0),
                                lpf.constant(Data.Str("name"))),
    ...
    "compile order by with root projection a table ref" in {
      ...
      //       differently
      testLogicalPlanCompile(sqlE"select foo from bar order by bar.baz",
    ...
    "compile order by with root projection a table ref with alias" in {
      // Note: not using wildcard here because the simple case is optimized
      //       differently
      testLogicalPlanCompile(sqlE"select foo from bar as b order by b.baz",
    ...
    "compile order by with root projection a table ref with alias, mismatched" in {
      testLogicalPlanCompile(sqlE"select * from bar as b order by bar.baz",
    ...
    "compile order by with root projection a table ref, embedded in expr" in {
      testLogicalPlanCompile(sqlE"select * from bar order by bar.baz/10",
    ...
    "compile order by with root projection a table ref, embedded in complex expr" in {
      testLogicalPlanCompile(sqlE"select * from bar order by bar.baz/10 - 3*bar.quux",
    ...
    "compile multiple stages" in {
      testLogicalPlanCompile(
        ...
        lpf.let(
          '__tmp0,
          read("person"), // from person
          lpf.let(
            '__tmp1, // where height > 60
            lpf.invoke2(Filter,
                        lpf.free('__tmp0),
                        lpf.invoke2(Gt,
                                    lpf.invoke2(ObjectProject,
                        ...
                        lpf.invoke1(
                          ...
                          lpf.invoke2(
                            ...
                            lpf.invoke2(Filter, // having count(*) > 10
                                        lpf.free('__tmp2),
                                        lpf.invoke2(Gt,
                                                    lpf.invoke1(Count, lpf.free('__tmp2)),
                                                    lpf.constant(Data.Int(10)))),
                            lpf.constant(Data.Str("height"))
                          )
                        ),
    ...
    "compile cross join to the equivalent inner equi-join" in {
      val query =
        sqlE"select foo.name, bar.address from foo, bar where foo.id = bar.foo_id"
      val equiv =
        sqlE"select foo.name, bar.address from foo join bar on foo.id = bar.foo_id"

      val expected = renameJoinSides(compileExp(equiv))('__leftJoin9,
                                                        '__leftJoin23,
                                                        '__rightJoin10,
                                                        '__rightJoin24)
    ...
    "compile inner join with additional equi-condition to the equivalent inner equi-join" in {
      val query =
        sqlE"select foo.name, bar.address from foo join bar on foo.id = bar.foo_id where foo.x = bar.y"
      val equiv =
        sqlE"select foo.name, bar.address from foo join bar on foo.id = bar.foo_id and foo.x = bar.y"
    ...
    "compile inner non-equi join to the equivalent cross join" in {
      ...
      val expected = renameJoinSides(compileExp(equiv))('__leftJoin23,
                                                        '__leftJoin9,
                                                        '__rightJoin24,
                                                        '__rightJoin10)
    ...
    "compile nested cross join to the equivalent inner equi-join" in {
      val query =
        sqlE"select a.x, b.y, c.z from a, b, c where a.id = b.a_id and b.`_id` = c.b_id"
      val equiv =
        sqlE"select a.x, b.y, c.z from (a join b on a.id = b.a_id) join c on b.`_id` = c.b_id"
              ...
              lpf.join(
                ...
                JoinCondition(
                  ...
                  lpf.invoke2(
                    Eq,
                    lpf.invoke2(ObjectProject,
                                lpf.joinSideName('__leftJoin23),
                                lpf.constant(Data.Str("id"))),
                    lpf.invoke2(ObjectProject,
                                lpf.joinSideName('__rightJoin24),
                                lpf.constant(Data.Str("foo_id")))
                  )
                )
              ),
          ...
          lpf.join(
            ...
            JoinCondition(
              ...
              lpf.invoke2(
                Lt,
                lpf.invoke2(ObjectProject,
                            lpf.joinSideName('left1),
                            lpf.constant(Data.Str("id"))),
                lpf.invoke2(ObjectProject,
                            lpf.joinSideName('right2),
                            lpf.constant(Data.Str("foo_id")))
              )
            )
          ),
            ...
            lpf.invoke1(
              ...
              makeObj(
                "name" -> lpf.invoke2(ObjectProject,
                                      lpf.free('__tmp0),
                                      lpf.constant(Data.Str("city"))),
                "size" -> lpf.invoke2(ObjectProject,
                                      lpf.free('__tmp0),
                                      lpf.constant(Data.Str("pop")))
              )
            ),
        ...
        lpf.let(
          ...
          lpf.let(
            ...
            lpf.invoke1(
              Squash,
              makeObj(
                "city" -> lpf.invoke2(ObjectProject,
                                      lpf.free('__tmp0),
                                      lpf.constant(Data.Str("city"))),
                "pop" -> lpf.invoke2(ObjectProject,
                                     lpf.free('__tmp0),
            ...
            lpf.let(
              ...
              lpf.sort(lpf.free('__tmp1),
                       (lpf.invoke2(ObjectProject,
                                    lpf.free('__tmp1),
                                    lpf.constant(Data.Str("__sd__0"))),
                        SortDir.desc).wrapNel),
              lpf.invoke2(
                DeleteField,
                lpf.invoke2(DistinctBy,
                            lpf.free('__tmp2),
        ...
        lpf.let(
          ...
          lpf.invoke1(
            ...
            lpf.invoke1(
              Squash,
              makeObj(
                "CTY" -> lpf.invoke2(ObjectProject,
                                     lpf.free('__tmp0),
                                     lpf.constant(Data.Str("city"))),
                "ST" -> lpf.invoke2(ObjectProject,
                                    lpf.free('__tmp0),
                                    lpf.constant(Data.Str("state")))
              )
            )
          )
        )
    ...
    "compile count distinct with two exprs" in {
      testLogicalPlanCompile(sqlE"select count(distinct city, state) from zips",
                             read("zips"))
    }.pendingUntilFixed

    "compile distinct as function" in {
      testLogicalPlanCompile(sqlE"select distinct(city, state) from zips", read("zips"))
    }.pendingUntilFixed
      ...
      compile(sqlE"select foo from bar, baz") must beLeftDisjunction(
        NonEmptyList(
          SemanticError.AmbiguousReference(
            ...
            List(TableRelationAST(currentDir </> file("baz"), None),
                 TableRelationAST(currentDir </> file("bar"), None)))))
    }

    "fail with ambiguous reference in cond" in {
      compile(
        sqlE"""select (case when a = 1 then "ok" else "reject" end) from bar, baz""") must beLeftDisjunction
    }
    ...
    "fail with duplicate alias" in {
      compile(
        sqlE"select car.name as name, owner.name as name from owners as owner join cars as car on car.`_id` = owner.carId") must_===
        SemanticError.duplicateAlias("name").wrapNel.left
    }

    "translate free variable" in {
      testLogicalPlanCompile(
        sqlE"select name from zips where age < :age",
        lpf.let(
          '__tmp0,
          read("zips"),
          lpf.invoke1(
          ...
          lpf.let(
            ...
            lpf.invoke2(GroupBy,
                        ...
                        MakeArrayN[Fix[LP]](
                          lpf.invoke2(ObjectProject,
                                      lpf.free('tmp0),
                                      lpf.constant(Data.Str("city")))).embed),
          ...
          lpf.let(
            ...
            lpf.let(
              ...
              lpf.invoke2(Filter,
                          lpf.free('tmp1),
                          lpf.invoke2(Gt,
                                      lpf.invoke1(Count, lpf.free('tmp1)),
                                      lpf.constant(Data.Int(10)))),
          ...
          lpf.let(
            ...
            lpf.invoke2(
              ...
              MakeArrayN[Fix[LP]](lpf.invoke2(ObjectProject,
                                  ...
                                  lpf.invoke2(ObjectProject,
                                              lpf.free('tmp0),
                                              lpf.constant(Data.Str("state")))).embed
            ),
            makeObj(
              "city" -> lpf.invoke2(ObjectProject,
                                    lpf.free('tmp1),
  ...
  "constant folding" >> {
    def testFolding(name: String, query: String, expected: Fix[Sql]) = {
      ...
      s"${name} with collection" >> {
        testTypedLogicalPlanCompile(unsafeParse(s"$query from zips"),
                                    fullCompileExp(expected))
      }
    }

    testFolding("ARBITRARY", "select arbitrary((3, 4, 5))", sqlE"select 3")

    testFolding("AVG", "select avg((0.5, 1.0, 4.5))", sqlE"select 2.0")

    testFolding("COUNT", """select count(("foo", "quux", "baz"))""", sqlE"select 3")

    testFolding("MAX", "select max((4, 2, 1001, 17))", sqlE"select 1001")

    testFolding("MIN", "select min((4, 2, 1001, 17))", sqlE"select 2")

    testFolding("SUM", "select sum((1, 1, 1, 1, 1, 3, 4))", sqlE"select 12")
  }
