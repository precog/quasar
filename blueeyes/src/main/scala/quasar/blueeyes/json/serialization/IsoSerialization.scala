...
object IsoSerialization {
  ...
  object DecomposerAux {
    ...
    implicit def hlistDecomposer1[FT <: HList, H, T <: HList](
        implicit dh: Decomposer[H],
    ...
    implicit def hlistDecomposer2[FT <: HList, H, T <: HList](
        implicit dh: Decomposer[H],
        dt: DecomposerAux[FT, T]) =
    ...
    implicit def hlistDecomposer3[FT <: HList, H, T <: HList](
        implicit dh: Decomposer[H],
        dt: DecomposerAux[FT, T]) =
    ...
    implicit def hlistDecomposer4[FT <: HList, H, T <: HList](
        implicit dh: Decomposer[H],
        dt: DecomposerAux[FT, T]) =
    ...
    implicit def hlistDecomposer5[FT <: HList, H, T <: HList](
        implicit dh: Decomposer[H],
        dt: DecomposerAux[FT, T]) =
    ...
    implicit def hlistDecomposer6[FT <: HList, H, T <: HList](
        implicit dh: Decomposer[H],
        dt: DecomposerAux[FT, T]) =
    ...
    implicit def hlistDecomposer9[FT <: HList, H, T <: HList](
        implicit dh: Decomposer[H],
        dt: DecomposerAux[FT, T]) =
  ...
  object ExtractorAux {
    ...
    implicit def hlistExtractor1[FT <: HList, H, T <: HList](
        implicit eh: Extractor[H],
    ...
    implicit def hlistExtractor2[FT <: HList, H, T <: HList](
        implicit eh: Extractor[H],
        et: ExtractorAux[FT, T]) =
    ...
    implicit def hlistExtractor3[FT <: HList, H, T <: HList](
        implicit eh: Extractor[H],
        et: ExtractorAux[FT, T]) =
    ...
    implicit def hlistExtractor6[FT <: HList, H, T <: HList](
        implicit eh: Extractor[H],
        et: ExtractorAux[FT, T]) =
  ...
  class IsoDecomposer[T, F <: HList, L <: HList](
      fields: F,
      iso: Generic.Aux[T, L],
  ...
  class IsoExtractor[T, F <: HList, L <: HList](
      fields: F,
      iso: Generic.Aux[T, L],
