...
import quasar.physical.couchbase._, common.ContextReader,
N1QL.{Id, Union, Unreferenced, _}, planner.Planner._, Select.{Filter, Value, _}, Case._
        ...
        u <- (id match {
          ...
          case IncludeId =>
            Case(
              ...
              Else(
                ArrFor(expr = Arr(List(id3.embed, SelectElem(s, id3.embed).embed)).embed,
                       `var` = id3.embed,
