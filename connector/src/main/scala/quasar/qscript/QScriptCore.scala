...
import quasar.{NonTerminal, RenderTree, RenderTreeT, Terminal}, RenderTree.ops._
 ...
 */
@Lenses final case class Filter[T[_[_]], A](src: A, f: FreeMap[T]) extends QScriptCore[T, A]
...
object QScriptCore {
  ...
  implicit def renderTree[T[_[_]]: RenderTreeT: ShowT]: Delay[RenderTree, QScriptCore[T, ?]] =
      ...
      def mergeSrcs(
        ...
        (p1, p2) match {
          ...
          case (Map(_, m1), Map(_, m2)) =>
            ...
            SrcMerge[QScriptCore[IT, ExternallyManaged], FreeMap[IT]](Map(Extern, mf), lv, rv).some
          ...
          case (LeftShift(_, struct1, id1, repair1), LeftShift(_, struct2, id2, repair2)) =>
