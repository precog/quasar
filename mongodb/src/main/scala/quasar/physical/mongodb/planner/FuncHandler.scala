...
@typeclass trait FuncHandler[IN[_]] {
  ...
  def handleOps3_4[EX[_]: Functor](
      ...
      e30: ExprOp3_0F :<: EX,
      e32: ExprOp3_2F :<: EX,
      e34: ExprOp3_4F :<: EX): IN ~> OptionFree[EX, ?]
  ...
  def handle2_6(v: BsonVersion): IN ~> OptionFree[Expr2_6, ?] =
    λ[IN ~> OptionFree[Expr2_6, ?]] { f =>
      val h = handleOpsCore[Expr2_6](v, trunc2_6)
      h(f)
    }

  def handle3_0(v: BsonVersion): IN ~> OptionFree[Expr3_0, ?] =
  ...
  def handle3_2(v: BsonVersion): IN ~> OptionFree[Expr3_2, ?] =
  ...
  def handle3_4(v: BsonVersion): IN ~> OptionFree[Expr3_4, ?] =
  ...
  implicit def mapFuncCore[T[_[_]]: BirecursiveT]: FuncHandler[MapFuncCore[T, ?]] =
    new FuncHandler[MapFuncCore[T, ?]] {
          ...
          def apply[A](mfc: MapFuncCore[T, A]): OptionFree[EX, A] = {
            ...
            def partial(mfc: MapFuncCore[T, A]): OptionFree[EX, A] = mfc.some collect {
              ...
              case ExtractCentury(a1) =>
                trunc(
                  $divide($add($year(a1), $literal(Bson.Int32(99))), $literal(Bson.Int32(100))))
              ...
              case ExtractIsoDayOfWeek(a1) =>
                $cond(
                  $eq($dayOfWeek(a1), $literal(Bson.Int32(1))),
              ...
              case ExtractMillennium(a1) =>
                trunc(
                  $divide(
                    $add($year(a1), $literal(Bson.Int32(999))),
                    $literal(Bson.Int32(1000))))
          ...
          def apply[A](mfc: MapFuncCore[T, A]): OptionFree[EX, A] = {
            ...
            mfc.some collect {
              ...
              case ConcatArrays(a1, a2) =>
                $let(
                  ListMap(DocVar.Name("a1") -> a1, DocVar.Name("a2") -> a2),
                  $cond(
      ...
      def handleOps3_4[EX[_]: Functor](
          ...
          e30: ExprOp3_0F :<: EX,
          e32: ExprOp3_2F :<: EX,
          e34: ExprOp3_4F :<: EX): MapFuncCore[T, ?] ~> OptionFree[EX, ?] =
        new (MapFuncCore[T, ?] ~> OptionFree[EX, ?]) {
          implicit def hole[D](d: D): Free[EX, D] = Free.pure(d)
          ...
          def apply[A](mfc: MapFuncCore[T, A]): OptionFree[EX, A] = {
            ...
            mfc.some collect {
              ...
              case Substring(a1, a2, a3) =>
                $cond(
                  $or($lt(a2, $literal(Bson.Int32(0))), $gt(a2, $strLenCP(a1))),
                  $literal(Bson.Text("")),
                  $cond(
  ...
  def mapFuncDerived[T[_[_]]: CorecursiveT]: FuncHandler[MapFuncDerived[T, ?]] =
    new FuncHandler[MapFuncDerived[T, ?]] {
      ...
      def handleOps3_4[EX[_]: Functor](
          ...
          e30: ExprOp3_0F :<: EX,
          e32: ExprOp3_2F :<: EX,
          e34: ExprOp3_4F :<: EX): MapFuncDerived[T, ?] ~> OptionFree[EX, ?] =
        emptyDerived
    }
  ...
  implicit def mapFuncDerivedUnhandled[T[_[_]]: CorecursiveT](
    ...
    new FuncHandler[MapFuncDerived[T, ?]] {
      ...
      private def handleUnhandled[F[_]](
          derived: MapFuncDerived[T, ?] ~> OptionFree[F, ?],
  ...
  implicit def mapFuncCoproduct[F[_], G[_]](
    ...
    new FuncHandler[Coproduct[F, G, ?]] {
      ...
      def handleOps3_4[EX[_]: Functor](
          ...
          e30: ExprOp3_0F :<: EX,
          e32: ExprOp3_2F :<: EX,
          e34: ExprOp3_4F :<: EX): Coproduct[F, G, ?] ~> OptionFree[EX, ?] =
        λ[Coproduct[F, G, ?] ~> OptionFree[EX, ?]](
          _.run.fold(
