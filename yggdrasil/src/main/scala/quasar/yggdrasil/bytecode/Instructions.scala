...
class InstructionSet[Lib <: Library](val library: Lib) {
  ...
  final case class Line(line: Int, col: Int, text: String) extends DataInstr {
  ...
  sealed abstract class NumericBinaryOperation
      extends BinaryOperation(BinOpType(JNumberT))
  sealed abstract class NumericComparisonOperation
      extends BinaryOperation(BinaryOperationType(DateNumUnion, DateNumUnion, JBooleanT))
  sealed abstract class BooleanBinaryOperation
      extends BinaryOperation(BinOpType(JBooleanT))
  sealed abstract class EqualityOperation
      extends BinaryOperation(BinaryOperationType(JUniverseT, JUniverseT, JBooleanT))
  ...
  final case object ArraySwap
      extends BinaryOperation(
        BinaryOperationType(JArrayUnfixedT, JNumberT, JArrayUnfixedT))
  final case object Comp extends UnaryOperation(UnaryOperationType(JBooleanT, JBooleanT))
  final case object DerefArray
      extends BinaryOperation(BinaryOperationType(JArrayUnfixedT, JNumberT, JUniverseT))
  final case object DerefMetadata extends BinaryOperation(BinOpType(JUniverseT))
  final case object DerefObject
      extends BinaryOperation(BinaryOperationType(JObjectUnfixedT, JTextT, JUniverseT))
  ...
  final case object WrapArray
      extends UnaryOperation(UnaryOperationType(JUniverseT, JArrayUnfixedT))
  final case object WrapObject
      extends BinaryOperation(BinaryOperationType(JTextT, JUniverseT, JObjectUnfixedT))
}
