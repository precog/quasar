...
import quasar.{Data, SemanticError, Type}
...
class CompilerSpec extends quasar.Qspec with CompilerHelpers {
  ...
  "compiler" should {
    ...
    "compile simple constant example 1 with field name" in {
      testLogicalPlanCompile(sqlE"select 1 as one", makeObj("one" -> lpf.constant(Data.Int(1))))
    }
    ...
    "compile simple constant with multiple named projections" in {
      testLogicalPlanCompile(
        ...
        makeObj("a" -> lpf.constant(Data.Dec(1.0)), "b" -> lpf.constant(Data.Str("abc"))))
    }

    "compile complex constant" in {
      testTypedLogicalPlanCompile(
        sqlE"[1, 2, 3, 4, 5][*] limit 3 offset 1",
      ...
      testLogicalPlanCompile(
        ...
        lpf.let(
          ...
          lpf.invoke1(
            ...
            makeObj(
              "name" -> lpf
                .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("name"))),
              "place" -> lpf
                .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("place")))
            )
          )
        )
      )
    ...
    "compile negate" in {
      testLogicalPlanCompile(
        ...
        lpf.invoke1(
          ...
          lpf.invoke1(
            Negate,
            lpf.invoke2(ObjectProject, read("bar"), lpf.constant(Data.Str("foo"))))))
    }
    ...
    "filter on constant false" in {
      testTypedLogicalPlanCompile(
        sqlE"select * from zips where false",
        lpf.constant(Data.Set(Nil)))
    }

    "filter with field in empty set" in {
      testTypedLogicalPlanCompile(
        sqlE"select * from zips where state in ()",
        lpf.constant(Data.Set(Nil)))
    }
              ...
              lpf.invoke2(
                ...
                lpf.invoke1(
                  ...
                  lpf.invoke3(
                    Search,
                    lpf
                      .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("bar"))),
                    lpf.constant(Data.Str("^a.*$")),
                    lpf.constant(Data.Bool(false)))
                )
              ),
              ...
              makeObj(
                ...
                "2" ->
                  lpf.invoke1(
                    Avg,
                    lpf
                      .invoke2(ObjectProject, lpf.free('__tmp1), lpf.constant(Data.Str("age"))))
              )
            )
          )
        )
      ...
      testLogicalPlanCompile(
        ...
        lpf.invoke1(
          ...
          lpf.invoke2(
            ...
            lpf.invoke1(
              Sum,
              lpf.invoke2(ObjectProject, read("zips"), lpf.constant(Data.Str("pop")))),
    ...
    val setA =
      lpf.let(
        ...
        lpf.invoke1(
          ...
          makeObj(
            "loc" -> lpf
              .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("loc"))),
            "pop" -> lpf
              .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("pop")))
          )
        )
      )
    val setB =
    ...
    "compile union" in {
      testLogicalPlanCompile(
        ...
        lpf.normalizeLets(lpf.normalizeLets(lpf.let(
          '__tmp1,
          lpf.invoke2(Union, setA, setB),
          lpf.invoke1(Arbitrary, lpf.invoke2(GroupBy, lpf.free('__tmp1), lpf.free('__tmp1))))))
      )
    }
        ...
        lpf.invoke1(
          ...
          lpf.invoke1(
            ...
            lpf.invoke2(
              ...
              lpf.invoke1(
                ShiftArray,
                lpf.invoke2(ObjectProject, read("zips"), lpf.constant(Data.Str("loc")))),
              lpf.constant(Data.Int(10)))
          )
        )
      )
            ...
            lpf.invoke1(
              ...
              makeObj(
                "name" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("name"))),
                "__sd__0" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("height")))
              )
            ),
            lpf.invoke2(
              DeleteField,
      ...
      testLogicalPlanCompile(
        ...
        lpf.let(
          ...
          lpf.invoke1(
            ...
            lpf.invoke1(
              FlattenArray,
              lpf.invoke2(ObjectProject, read("foo"), lpf.constant(Data.Str("quux"))))),
          lpf.sort(lpf.free('__tmp0), (lpf.free('__tmp0), SortDir.asc).wrapNel)
        )
      )
    }
          ...
          lpf.let(
            ...
            lpf.let(
              ...
              lpf.invoke1(
                ...
                makeObj(
                  "name" -> lpf
                    .invoke2(ObjectProject, lpf.free('__tmp1), lpf.constant(Data.Str("name"))),
                  "__sd__0" -> lpf
                    .invoke2(ObjectProject, lpf.free('__tmp1), lpf.constant(Data.Str("height")))
                )
              ),
              lpf.invoke2(
                DeleteField,
          ...
          lpf.sort(
            ...
            NonEmptyList(
              (
                ...
                SortDir.desc),
              (
                lpf.invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("name"))),
                SortDir.asc)
            )
          )
        )
      ...
      testLogicalPlanCompile(
        ...
        lpf.let(
          ...
          lpf.invoke1(
            ...
            makeObj(
              "name" -> lpf
                .invoke2(ObjectProject, read("person"), lpf.constant(Data.Str("firstName"))))),
          lpf.sort(
            lpf.free('__tmp0),
            (
              lpf.invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("name"))),
    ...
    "compile simple sum" in {
      testLogicalPlanCompile(
        ...
        lpf.invoke1(
          ...
          lpf.invoke1(
            Sum,
            lpf.invoke2(ObjectProject, read("person"), lpf.constant(Data.Str("height"))))))
    }
        ...
        lpf.let(
          ...
          lpf.let(
            ...
            lpf.invoke1(
              ...
              makeObj(
                "name" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("city"))),
                "size" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("pop")))
              )
            ),
            lpf.invoke1(
              ...
              makeObj(
                "name" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp1), lpf.constant(Data.Str("name"))),
                "size" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp1), lpf.constant(Data.Str("size")))
              )
            )
          )
        )
        ...
        lpf.let(
          ...
          lpf.let(
            ...
            lpf.invoke1(
              ...
              makeObj(
                "city" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp1), lpf.constant(Data.Str("city"))),
                "pop" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp1), lpf.constant(Data.Str("pop")))
              )
            )
          )
        )
      ...
      testLogicalPlanCompile(
        ...
        lpf.let(
          ...
          lpf.invoke1(
            Squash,
            lpf.invoke2(ObjectProject, read("zips"), lpf.constant(Data.Str("city")))),
          lpf.invoke1(Arbitrary, lpf.invoke2(GroupBy, lpf.free('__tmp0), lpf.free('__tmp0)))
        )
      )
    }
      ...
      testLogicalPlanCompile(
        ...
        lpf.let(
          ...
          lpf.let(
            ...
            lpf.sort(
              lpf
                .invoke1(Arbitrary, lpf.invoke2(GroupBy, lpf.free('__tmp1), lpf.free('__tmp1))),
              (
                lpf.invoke1(
                  Arbitrary,
            ...
            lpf.invoke1(
              ...
              makeObj(
                "CTY" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("city"))),
                "ST" -> lpf
                  .invoke2(ObjectProject, lpf.free('__tmp0), lpf.constant(Data.Str("state")))
              )
            ),
            lpf.invoke1(Arbitrary, lpf.invoke2(GroupBy, lpf.free('__tmp1), lpf.free('__tmp1)))
          )
    ...
    "compile count distinct with two exprs" in {
      testLogicalPlanCompile(sqlE"select count(distinct city, state) from zips", read("zips"))
    }.pendingUntilFixed
      ...
      val lp =
        lpf.let(
          ...
          lpf.let(
            ...
            makeObj(
              "city" -> lpf
                .invoke2(ObjectProject, lpf.free('tmp1), lpf.constant(Data.Str("city"))),
              "1" -> lpf.invoke1(
                Count,
                lpf.invoke2(ObjectProject, lpf.free('tmp1), lpf.constant(Data.Str("state")))),
              "loc" -> lpf
                .invoke2(ObjectProject, lpf.free('tmp1), lpf.constant(Data.Str("loc"))),
              "2" -> lpf.invoke1(
                Sum,
                lpf.invoke2(ObjectProject, lpf.free('tmp1), lpf.constant(Data.Str("pop"))))
            )
          )
        )
      val exp =
