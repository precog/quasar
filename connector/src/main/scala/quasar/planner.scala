...
object Planner {
  ...
  final case class UnsupportedFunction[N <: Nat](func: GenericFunc[N], hint: Option[String])
  ...
  final case class FuncApply[N <: Nat](func: GenericFunc[N], expected: String, actual: String)
      extends PlannerError {
    def message =
  ...
  object CompilationError {
    ...
    final case class ManyErrors(errors: NonEmptyList[SemanticError]) extends CompilationError {
