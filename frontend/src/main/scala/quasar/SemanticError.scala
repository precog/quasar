...
object SemanticError {
  ...
  final case class InvalidFunctionDefinition(funcDef: FunctionDecl[Fix[Sql]], reason: String)
      extends SemanticError {
  ...
  final case class VariableParseError(
      vari: VarName,
      value: VarValue,
  ...
  final case class DateFormatError[N <: Nat](
      func: GenericFunc[N],
      str: String,
      hint: Option[String])
      extends SemanticError {
