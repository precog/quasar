...
trait GrouperSpec extends SpecificationLike with ScalaCheck { self =>
  ...
  def augmentWithIdentities(json: Stream[JValue]) = json.zipWithIndex map {
    case (v, i) =>
      JObject(JField("key", JArray(JNum(i) :: Nil)) :: JField("value", v) :: Nil)
  }
  ...
  def testHistogramExtraAnd = {
    ...
    val spec = GroupingSource(
      ...
      GroupKeySpecAnd(
        GroupKeySpecSource(
          CPathField("extra"),
          Filter(Map1(DerefObjectStatic(SourceValue.Single, CPathField("a")), eq12F1),
  ...
  def testCtrPartialJoinAnd(rawData1: Stream[(Int, Option[Int])], rawData2: Stream[Int]) = {
    ...
    val intersection = GroupingAlignment(DerefObjectStatic(Leaf(Source), tic_a),
                                         DerefObjectStatic(Leaf(Source), tic_a),
                                         spec1,
                                         spec2,
                                         GroupingSpec.Intersection)
  ...
  "multi-set grouping" should {
    ...
    "compute ctr with simple datasets" in testCtr(Stream(-565998477, 1911906594, 1),
    ...
    "compute ctr on one field of a composite value" >> {
      ...
      "and with un-joinable datasets" >> testCtrPartialJoinAnd(
        ...
        Stream(-1675865668, 889796884, 2147483647, -1099860336, -2147483648, -2147483648,
          1, 1496400141)
      )
      ...
      "or with a pathological example" >> {
        ...
        val s2 = Stream(0, 0, 0, 1, 1, 434608913, 193294286, 0, -1921860406, 2147483647,
          -2147483648, 1, -1, 0, -2147483648, 0, -113276442, -1564947365, 2147483647,
          -54676151, -1, 49986682, -391210112, 1, -1, 2147483647, 0, -1, 0, 0, 2147483647,
          -225140804, 1245119802, 1, -548778232, -1138847365, 1, 73483948, 0, -1,
          -996046474, -695581403, 2147483647, -2147483648, -1, 1563916971, -2147483648, 0,
          1, 607908889, -2009071663, -1382431435, 778550183, 2147483647, -2147483648, 0,
          -1)
