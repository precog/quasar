...
abstract class StdLibSpec extends Qspec {
      ...
      (v, expected) match {
        case (Data.Number(x), Data.Number(exp)) =>
          result(isClose(x, exp, 1e-9),
                 ...
                 s"$x is a Number but does not match $exp",
                 s)
        case _ =>
          result(Equal[Data].equal(v, expected),
                 s"$v matches $expected",
                 s"$v does not match $expected",
                 s)
      }
    }
  }
  ...
  def tests(runner: StdLibTestRunner) = {
    ...
    implicit val arbData = Arbitrary[Data] {
      Gen.oneOf(runner.intDomain.map(Data.Int(_)),
                runner.decDomain.map(Data.Dec(_)),
                runner.stringDomain.map(Data.Str(_)))
    }

    def commute(prg: (Fix[LogicalPlan], Fix[LogicalPlan]) => Fix[LogicalPlan],
                arg1: Data,
                arg2: Data,
    ...
    "DateLib" >> {
      ...
      "ExtractCentury" >> {
        "0001-01-01" >> {
          unary(ExtractCentury(_).embed,
                Data.Date(LocalDate.parse("0001-01-01")),
                Data.Int(1))
        }

        "2000-01-01" >> {
          unary(ExtractCentury(_).embed,
                Data.Date(LocalDate.parse("2000-01-01")),
                Data.Int(20))
        }

        "2001-01-01" >> {
          unary(ExtractCentury(_).embed,
                Data.Date(LocalDate.parse("2001-01-01")),
                Data.Int(21))
        }

        "midnight 0001-01-01" >> {
          unary(ExtractCentury(_).embed,
                Data.Timestamp(Instant.parse("0001-01-01T00:00:00.000Z")),
                Data.Int(1))
        }

        "midnight 2000-01-01" >> {
          unary(ExtractCentury(_).embed,
                Data.Timestamp(Instant.parse("2000-01-01T00:00:00.000Z")),
                Data.Int(20))
        }

        "midnight 2001-01-01" >> {
          unary(ExtractCentury(_).embed,
                Data.Timestamp(Instant.parse("2001-01-01T00:00:00.000Z")),
                Data.Int(21))
        }
      }
      ...
      "ExtractDayOfMonth" >> {
        "2016-01-01" >> {
          unary(ExtractDayOfMonth(_).embed,
                Data.Date(LocalDate.parse("2016-01-01")),
                Data.Int(1))
        }

        "midnight 2016-01-01" >> {
          unary(ExtractDayOfMonth(_).embed,
                Data.Timestamp(Instant.parse("2016-01-01T00:00:00.000Z")),
                Data.Int(1))
        }

        "2016-02-29" >> {
          unary(ExtractDayOfMonth(_).embed,
                Data.Date(LocalDate.parse("2016-02-29")),
                Data.Int(29))
        }

        "midnight 2016-02-29" >> {
          unary(ExtractDayOfMonth(_).embed,
                Data.Timestamp(Instant.parse("2016-02-29T00:00:00.000Z")),
                Data.Int(29))
        }
      }
      ...
      "ExtractDecade" >> {
        "1999-12-31" >> {
          unary(ExtractDecade(_).embed,
                Data.Date(LocalDate.parse("1999-12-31")),
                Data.Int(199))
        }

        "midnight 1999-12-31" >> {
          unary(ExtractDecade(_).embed,
                Data.Timestamp(Instant.parse("1999-12-31T00:00:00.000Z")),
                Data.Int(199))
        }
      }
      ...
      "ExtractDayOfWeek" >> {
        "2016-09-28" >> {
          unary(ExtractDayOfWeek(_).embed,
                Data.Date(LocalDate.parse("2016-09-28")),
                Data.Int(3))
        }

        "midnight 2016-09-28" >> {
          unary(ExtractDayOfWeek(_).embed,
                Data.Timestamp(Instant.parse("2016-09-28T00:00:00.000Z")),
                Data.Int(3))
        }

        "2016-10-02" >> {
          unary(ExtractDayOfWeek(_).embed,
                Data.Date(LocalDate.parse("2016-10-02")),
                Data.Int(0))
        }

        "midnight 2016-10-02" >> {
          unary(ExtractDayOfWeek(_).embed,
                Data.Timestamp(Instant.parse("2016-10-02T00:00:00.000Z")),
                Data.Int(0))
        }

        "2016-10-08" >> {
          unary(ExtractDayOfWeek(_).embed,
                Data.Date(LocalDate.parse("2016-10-08")),
                Data.Int(6))
        }

        "noon 2016-10-08" >> {
          unary(ExtractDayOfWeek(_).embed,
                Data.Timestamp(Instant.parse("2016-10-08T12:00:00.000Z")),
                Data.Int(6))
        }
      }
      ...
      "ExtractDayOfYear" >> {
        "2016-03-01" >> {
          unary(ExtractDayOfYear(_).embed,
                Data.Date(LocalDate.parse("2016-03-01")),
                Data.Int(61))
        }

        "midnight 2016-03-01" >> {
          unary(ExtractDayOfYear(_).embed,
                Data.Timestamp(Instant.parse("2016-03-01T00:00:00.000Z")),
                Data.Int(61))
        }

        "2017-03-01" >> {
          unary(ExtractDayOfYear(_).embed,
                Data.Date(LocalDate.parse("2017-03-01")),
                Data.Int(60))
        }

        "midnight 2017-03-01" >> {
          unary(ExtractDayOfYear(_).embed,
                Data.Timestamp(Instant.parse("2017-03-01T00:00:00.000Z")),
                Data.Int(60))
        }
      }
      ...
      "ExtractEpoch" >> {
        "2016-09-29" >> {
          unary(ExtractEpoch(_).embed,
                Data.Date(LocalDate.parse("2016-09-29")),
                Data.Dec(1475107200.0))
        }

        "2016-09-29 12:34:56.789" >> {
          unary(ExtractEpoch(_).embed,
                Data.Timestamp(Instant.parse("2016-09-29T12:34:56.789Z")),
                Data.Dec(1475152496.789))
        }
      }

      "ExtractHour" >> {
        "2016-09-29" >> {
          unary(ExtractHour(_).embed,
                Data.Date(LocalDate.parse("2016-09-29")),
                Data.Int(0))
        }
        ...
        "2016-09-29 12:34:56.789" >> {
          unary(ExtractHour(_).embed,
                Data.Timestamp(Instant.parse("2016-03-01T12:34:56.789Z")),
                Data.Int(12))
        }
      }
      ...
      "ExtractIsoDayOfWeek" >> {
        "2016-09-28" >> {
          unary(ExtractIsoDayOfWeek(_).embed,
                Data.Date(LocalDate.parse("2016-09-28")),
                Data.Int(3))
        }
      ...
      "ExtractIsoYear" >> {
        "2006-01-01" >> {
          unary(ExtractIsoYear(_).embed,
                Data.Date(LocalDate.parse("2006-01-01")),
                Data.Int(2005))
        }

        "midnight 2006-01-01" >> {
          unary(ExtractIsoYear(_).embed,
                Data.Timestamp(Instant.parse("2006-01-01T00:00:00.000Z")),
                Data.Int(2005))
        }

        "2006-01-02" >> {
          unary(ExtractIsoYear(_).embed,
                Data.Date(LocalDate.parse("2006-01-02")),
                Data.Int(2006))
        }

        "midnight 2006-01-02" >> {
          unary(ExtractIsoYear(_).embed,
                Data.Timestamp(Instant.parse("2006-01-02T00:00:00.000Z")),
                Data.Int(2006))
        }
      }
      ...
      "ExtractMicroseconds" >> {
        "2016-09-29" >> {
          unary(ExtractMicroseconds(_).embed,
                Data.Date(LocalDate.parse("2016-09-29")),
                Data.Dec(0))
        }
      ...
      "ExtractMillennium" >> {
        "0001-01-01" >> {
          unary(ExtractMillennium(_).embed,
                Data.Date(LocalDate.parse("0001-01-01")),
                Data.Int(1))
        }
      ...
      "ExtractMilliseconds" >> {
        "2016-09-29" >> {
          unary(ExtractMilliseconds(_).embed,
                Data.Date(LocalDate.parse("2016-09-29")),
                Data.Dec(0))
        }
      ...
      "ExtractQuarter" >> {
        "2016-10-03" >> {
          unary(ExtractQuarter(_).embed,
                Data.Date(LocalDate.parse("2016-10-03")),
                Data.Int(4))
        }

        "midnight 2016-10-03" >> {
          unary(ExtractQuarter(_).embed,
                Data.Timestamp(Instant.parse("2016-10-03T00:00:00.000Z")),
                Data.Int(4))
        }

        "2016-03-31 (leap year)" >> {
          unary(ExtractQuarter(_).embed,
                Data.Date(LocalDate.parse("2016-03-31")),
                Data.Int(1))
        }

        "midnight 2016-03-31 (leap year)" >> {
          unary(ExtractQuarter(_).embed,
                Data.Timestamp(Instant.parse("2016-03-31T00:00:00.000Z")),
                Data.Int(1))
        }

        "2016-04-01 (leap year)" >> {
          unary(ExtractQuarter(_).embed,
                Data.Date(LocalDate.parse("2016-04-01")),
                Data.Int(2))
        }

        "midnight 2016-04-01 (leap year)" >> {
          unary(ExtractQuarter(_).embed,
                Data.Timestamp(Instant.parse("2016-04-01T00:00:00.000Z")),
                Data.Int(2))
        }

        "2017-03-31" >> {
          unary(ExtractQuarter(_).embed,
                Data.Date(LocalDate.parse("2017-03-31")),
                Data.Int(1))
        }

        "midnight 2017-03-31" >> {
          unary(ExtractQuarter(_).embed,
                Data.Timestamp(Instant.parse("2017-03-31T00:00:00.000Z")),
                Data.Int(1))
        }

        "2017-04-01" >> {
          unary(ExtractQuarter(_).embed,
                Data.Date(LocalDate.parse("2017-04-01")),
                Data.Int(2))
        }

        "midnight 2017-04-01" >> {
          unary(ExtractQuarter(_).embed,
                Data.Timestamp(Instant.parse("2017-04-01T00:00:00.000Z")),
                Data.Int(2))
        }
      }
      ...
      "ExtractWeek" >> {
        ...
        "2001-02-16" >> {
          unary(ExtractWeek(_).embed,
                Data.Date(LocalDate.parse("2001-02-16")),
                Data.Int(7))
        }

        "midnight 2016-10-03" >> {
          unary(ExtractWeek(_).embed,
                Data.Timestamp(Instant.parse("2001-02-16T00:00:00.000Z")),
                Data.Int(7))
        }

        "2005-01-01" >> {
          unary(ExtractWeek(_).embed,
                Data.Date(LocalDate.parse("2005-01-01")),
                Data.Int(53))
        }

        "midnight 2005-01-01" >> {
          unary(ExtractWeek(_).embed,
                Data.Timestamp(Instant.parse("2005-01-01T00:00:00.000Z")),
                Data.Int(53))
        }
      }
      ...
      "StartOfDay" >> {
        "timestamp" >> prop { (x: Instant) =>
          ...
          truncZonedDateTime(TemporalPart.Day, t).fold(
            e => Failure(e.shows),
            tt =>
              unary(StartOfDay(_).embed, Data.Timestamp(x), Data.Timestamp(tt.toInstant)))
        }

        "date" >> prop { (x: LocalDate) =>
          unary(StartOfDay(_).embed,
                Data.Date(x),
      ...
      "TemporalTrunc" >> {
        def truncZonedDateTimeTimestamp(p: TemporalPart, i: Instant): Result =
          truncZonedDateTime(p, i.atZone(UTC)).fold(e => Failure(e.shows),
                                                    tt =>
                                                      unary(TemporalTrunc(p, _).embed,
                                                            Data.Timestamp(i),
                                                            Data.Timestamp(tt.toInstant)))

        "Q#1966" >>
          truncZonedDateTimeTimestamp(TemporalPart.Century,
        ...
        def truncZonedDateTimeDate(p: TemporalPart, d: LocalDate): Result =
          truncZonedDateTime(p, d.atStartOfDay(UTC)).fold(
            e => Failure(e.shows),
            tt =>
              unary(TemporalTrunc(p, _).embed, Data.Date(d), Data.Date(tt.toLocalDate)))
        ...
        def truncLocalTimeʹ(p: TemporalPart, t: LocalTime): Result =
          truncLocalTime(p, t).fold(
            e => Failure(e.shows),
            tt => unary(TemporalTrunc(p, _).embed, Data.Time(t), Data.Time(tt)))
    ...
    "MathLib" >> {
      ...
      "Multiply" >> {
        "any ints" >> prop { (x: Int, y: Int) =>
          binary(Multiply(_, _).embed,
                 Data.Int(x),
                 Data.Int(y),
                 Data.Int(x.toLong * y.toLong))
        }
      ...
      "Power" >> {
        ...
        "Int squared" >> prop { (x: Int) =>
          binary(Power(_, _).embed,
                 Data.Int(x),
                 Data.Int(2),
                 Data.Int(x.toLong * x.toLong))
        }
      ...
      "Divide" >> {
        "any ints" >> prop { (x: Int, y: Int) =>
          y != 0 ==>
            binary(Divide(_, _).embed,
                   Data.Int(x),
                   Data.Int(y),
                   Data.Dec(x.toDouble / y.toDouble))
        }
      ...
      "Modulo" >> {
        ...
        "any positive ints" >> prop { (x0: Int, y0: Int) =>
          ...
          val y = abs(y0)
          (x > 0 && y > 1) ==>
            binary(Modulo(_, _).embed,
                   Data.Int(x),
                   Data.Int(y),
                   Data.Int(BigInt(x) % BigInt(y)))
        }
    ...
    "StructuralLib" >> {
      ...
      "ConcatOp" >> {
        "array  || array" >> prop { (xs: List[BigInt], ys: List[BigInt]) =>
          ...
          binary(ConcatOp(_, _).embed,
                 Data._arr(xints),
                 Data._arr(yints),
                 Data._arr(xints ::: yints))
        }

        "array  || string" >> prop { (xs: List[BigInt], y: String) =>
          val (xints, ystrs) =
            (xs map (Data._int(_)), y.toList map (c => Data._str(c.toString)))
          binary(ConcatOp(_, _).embed,
                 Data._arr(xints),
                 Data._str(y),
                 Data._arr(xints ::: ystrs))
        }

        "string || array" >> prop { (x: String, ys: List[BigInt]) =>
          val (xstrs, yints) =
            (x.toList map (c => Data._str(c.toString)), ys map (Data._int(_)))
          binary(ConcatOp(_, _).embed,
                 Data._str(x),
                 Data._arr(yints),
                 Data._arr(xstrs ::: yints))
        }
