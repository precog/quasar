...
class CacheDirectiveSpec extends Specification {
  ...
  "Cache-Directive: Should parse a cache directive with a field correctly" in {
    ...
    HttpHeaders
      .`Cache-Control`(CacheDirectives.parseCacheDirectives(testString1): _*)
      .value mustEqual testString1
  }
  ...
  "Cache-Directive: Should parse a cache-directive with a delta " in {
    ...
    HttpHeaders
      .`Cache-Control`(CacheDirectives.parseCacheDirectives(testString2): _*)
      .value mustEqual testString2
  }
