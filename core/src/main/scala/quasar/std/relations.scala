...
trait RelationsLib extends Library {
  ...
  val Lt = BinaryFunc(
    ...
    Type.Bool,
    Sized[IS](Type.Comparable, Type.Comparable),
    noSimplification,
    partialTyper[nat._2] {
  ...
  val Between = TernaryFunc(
    ...
    Type.Bool,
    Sized[IS](Type.Comparable, Type.Comparable, Type.Comparable),
    noSimplification,
    partialTyper[nat._3] {
  ...
  val Cond = TernaryFunc(
    ...
    Type.Bottom,
    Sized[IS](Type.Bool, Type.Top, Type.Top),
    new Func.Simplifier {
      def apply[T[_[_]]: Recursive: Corecursive](orig: LogicalPlan[T[LogicalPlan]]) =
        orig match {
    ...
    untyper[nat._3](t => success(Sized[IS](Type.Bool, t, t))))
  ...
  val Coalesce = BinaryFunc(
    ...
    untyper[nat._2] {
      case Type.Null => success(Sized[IS](Type.Null, Type.Null))
      case t         => success(Sized[IS](t ⨿ Type.Null, Type.Top))
    })
