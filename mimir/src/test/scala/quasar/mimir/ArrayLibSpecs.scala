...
trait ArrayLibSpecs[M[+ _]]
  ...
  "array utilities" should {
    "flatten a homogeneous set" in {
      ...
      val input =
        dag.Morph1(Flatten, dag.AbsoluteLoad(Const(CString("/hom/arrays"))(line))(line))(line)
      ...
      values mustEqual Set(-9, -42, 42, 87, 4, 7, 6, 12, 0, 1024, 57, 77, 46.2, -100, 1, 19, 22,
    ...
    "flatten a heterogeneous set" in {
      ...
      val input =
        dag.Morph1(Flatten, dag.AbsoluteLoad(Const(CString("/het/arrays"))(line))(line))(line)
    ...
    "flattened set is related to original set" in {
      ...
      val input = dag.Join(
        ...
        dag.Join(
          ...
          dag.Morph1(Flatten, dag.AbsoluteLoad(Const(CString("/het/arrays"))(line))(line))(
            line))(line)
      )(line)
