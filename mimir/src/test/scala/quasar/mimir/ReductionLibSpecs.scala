...
trait ReductionLibSpecs[M[+ _]]
  ...
  "reduce homogeneous sets" >> {
    "first" >> {
      val input =
        dag.Reduce(First, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "last" >> {
      val input =
        dag.Reduce(Last, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "count" >> {
      val input =
        dag.Reduce(Count, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "count het numbers" >> {
      val input =
        dag.Reduce(Count, dag.AbsoluteLoad(Const(CString("/hom/numbersHet"))(line))(line))(line)
    ...
    "mean" >> {
      val input =
        dag.Reduce(Mean, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "mean het numbers" >> {
      val input =
        dag.Reduce(Mean, dag.AbsoluteLoad(Const(CString("/hom/numbersHet"))(line))(line))(line)
    ...
    "max" >> {
      val input =
        dag.Reduce(Max, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "max het numbers" >> {
      val input =
        dag.Reduce(Max, dag.AbsoluteLoad(Const(CString("/hom/numbersHet"))(line))(line))(line)
    ...
    "min" >> {
      val input =
        dag.Reduce(Min, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "min het numbers" >> {
      val input =
        dag.Reduce(Min, dag.AbsoluteLoad(Const(CString("/hom/numbersHet"))(line))(line))(line)
    ...
    "standard deviation" >> {
      val input =
        dag.Reduce(StdDev, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "sum" >> {
      val input =
        dag.Reduce(Sum, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "sumSq" >> {
      val input =
        dag.Reduce(SumSq, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "variance" >> {
      val input =
        dag.Reduce(Variance, dag.AbsoluteLoad(Const(CString("/hom/numbers"))(line))(line))(line)
    ...
    "forall" >> {
      val input =
        dag.Reduce(Forall, dag.IUI(true, Const(CTrue)(line), Const(CFalse)(line))(line))(line)
    ...
    "exists" >> {
      val input =
        dag.Reduce(Exists, dag.IUI(true, Const(CTrue)(line), Const(CFalse)(line))(line))(line)
  ...
  "reduce heterogeneous sets" >> {
    "count" >> {
      val input =
        dag.Reduce(Count, dag.AbsoluteLoad(Const(CString("/het/numbers"))(line))(line))(line)
    ...
    "mean" >> {
      val input =
        dag.Reduce(Mean, dag.AbsoluteLoad(Const(CString("/het/numbers"))(line))(line))(line)
    ...
    "max" >> {
      val input =
        dag.Reduce(Max, dag.AbsoluteLoad(Const(CString("/het/numbers"))(line))(line))(line)
    ...
    "min" >> {
      val input =
        dag.Reduce(Min, dag.AbsoluteLoad(Const(CString("/het/numbers"))(line))(line))(line)
    ...
    "standard deviation" >> {
      val input =
        dag.Reduce(StdDev, dag.AbsoluteLoad(Const(CString("/het/numbers"))(line))(line))(line)
    ...
    "sum" >> {
      val input =
        dag.Reduce(Sum, dag.AbsoluteLoad(Const(CString("/het/numbers"))(line))(line))(line)
    ...
    "sumSq" >> {
      val input =
        dag.Reduce(SumSq, dag.AbsoluteLoad(Const(CString("/het/numbers"))(line))(line))(line)
    ...
    "variance" >> {
      val input =
        dag.Reduce(Variance, dag.AbsoluteLoad(Const(CString("/het/numbers"))(line))(line))(line)
