...
final class Quasar[F[_], R, C <: SchemaConfig](
    ...
    val queryEvaluator: QueryEvaluator[Resource[F, ?], SqlQuery, (Option[F[∃[OffsetKey.Actual]]], R)],
...
object Quasar extends Logging {
  ...
  def apply[F[_]: ConcurrentEffect: ContextShift: MonadQuasarErr: PhaseResultTell: Timer, R, C <: SchemaConfig, A: Hash](
      ...
      queryFederation: QueryFederation[Fix, Resource[F, ?], QueryAssociate[Fix, Resource[F, ?], EvalResult[F]], (Option[F[∃[OffsetKey.Actual]]], R)],
