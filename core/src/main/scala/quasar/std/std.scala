...
trait StdLib extends Library {
  ...
  override val functions = math.functions ++ structural.functions ++ agg.functions ++ identity.functions ++ relations.functions ++ set.functions ++ array.functions ++ string.functions ++ date.functions ++ Nil
}
